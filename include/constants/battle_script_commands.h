...
#define VARIOUS_TRY_ACTIVATE_RAMPAGE            111
...
#define MOVEEND_MULTIHIT_MOVE                     19    // Everything up until here is handled for each strike of a multi-hit move
...
#define MOVEEND_CHANGED_ITEMS                     21
